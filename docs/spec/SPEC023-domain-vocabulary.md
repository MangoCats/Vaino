...
`[SPEC-VOC-010]` **The rule going forward:** normative prose — anything describing what the schema stores, the engine plays, or the Director scores — uses exactly one of the terms below, in the sense defined here. "Track" and "album" in their loose, everyday senses stay legitimate in UI copy and informal narration ("Why this track?", "browse by album"), never as a substitute for "passage" or "recording" in text that describes actual state.
