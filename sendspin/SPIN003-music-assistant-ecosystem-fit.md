...
| :--- | :--- | :--- |
| **A** | Sampo's library behind an OpenSubsonic-compatible surface | **None** — MA's existing Subsonic provider already speaks it |
...
**Traceability:** `[GDE-MSA-010..130]` · derived from `[GDE-SPIN-010..430]`, `[GDE-BAK-020]`, `[SPEC009]`, `[GDE-BMK-050]`
